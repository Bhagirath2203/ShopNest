...
import com.shopnest.backend.security.CustomUserDetailsService;
import com.shopnest.backend.security.JwtAuthenticationEntryPoint;
 ...
 * - Stateless session (no cookies/sessions — JWT only)
